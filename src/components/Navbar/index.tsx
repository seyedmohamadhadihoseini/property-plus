...
export default function NavbarMenu() {
    ...
    return (<nav className="bg-blue-700 border-b border-blue-500">
                ...
                >
                    ...
                    <div className=" md:ml-6 md:block">
                        <div className="flex space-x-2">
                            <Link
                                href="/"
                                className={`${pathname === "/" && "bg-black"} " text-white  hover:bg-gray-900 hover:text-white rounded-md p-1 px-3 py-2"`}
                            >Home</Link>
                            <Link
                                href="/properties"
                ...
                >
                    ...
                    {session &&
                        <div className="relative ml-3">
                            ...
                            <div
                                id="user-menu"
                                className={isProfileShow ? "absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" : "hidden"}
                                role="menu"
        ...
        <div className={isListShow ? "" : "hidden"} id="mobile-menu">
